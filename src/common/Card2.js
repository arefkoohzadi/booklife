  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center px-2">
      <div className="wrapper max-w-xs bg-gray-50 rounded-b-md shadow-lg overflow-hidden">
        ...
        <button className="bg-teal-600 w-full flex justify-center py-2 text-white font-semibold transition duration-700 hover:bg-teal-500">
          <svg
            fill="currentColor"
            viewBox="0 0 20 20"
